...
- builds the project
- runs a fixed list of 19 test binaries directly unless `--skip-tests` is used
...
- all 19 test targets build successfully
...
fixed list of 19 test binaries directly after building, which is useful when
